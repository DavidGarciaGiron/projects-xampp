...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            <a class="navbar-brand" href="admin.php" style="font-size: 18px; margin-top: 20px;">Administrador</a>
    ...
    <header class="masthead text-center text-white" style="height: 90%;">
        <div class="masthead-content">
            <div class="container">
                ...
                <h3 style="font-size: 30px;">Tipo de Usuario: <?php echo $_SESSION["usuario"]["privilegio"] == 1 ? 'Admin' : 'Cliente'; ?></h3>
                <br><br>
                ...
                <a href="../ver.php" class="btn btn-primary btn-xl rounded-pill mt-5" style="font-size: 20px;">Comenzar</a>
            </div>
        </div>
    </header>
    <!-- Footer -->
